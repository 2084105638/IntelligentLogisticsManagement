...
public class WaybillExceptionServiceImpl implements WaybillExceptionService {
    ...
    public WaybillExceptionServiceImpl(WaybillExceptionDao exceptionDao, WaybillDao waybillDao) {
    ...
    public void reportException(Long driverId, WaybillExceptionReportDTO dto) {
        ...
        exception.setWaybillId(dto.getWaybillId());
        exception.setDriverId(driverId);
        ...
        log.info("司机 {} 上报运单 {} 异常: {}", driverId, dto.getWaybillId(), dto.getDescription());
    }
}
